var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	let div8;
    	let t17;
    	let t18_value = /*formatter*/ ctx[7].format(/*monthlyPayments*/ ctx[3]) + "";
    	let t18;
    	let t19;
    	let div9;
    	let t20;
    	let t21_value = /*formatter*/ ctx[7].format(/*totalPay*/ ctx[6]) + "";
    	let t21;
    	let t22;
    	let div10;
    	let t23;
    	let t24_value = /*formatter*/ ctx[7].format(/*interestPaid*/ ctx[5]) + "";
    	let t24;
    	let mounted;
    	let dispose;
    	...
    	return {
    		c() {
    			...
    			attr(div3, "class", "columns six outputs svelte-18tkc21");
    			attr(div4, "class", "row");
    			attr(label2, "for", "");
    			...
    			attr(div6, "class", "columns six outputs svelte-18tkc21");
    			attr(div7, "class", "row");
    			attr(div8, "class", "row outputs svelte-18tkc21");
    			attr(div9, "class", "row outputs svelte-18tkc21");
    			attr(div10, "class", "row outputs svelte-18tkc21");
    		...
    		m(target, anchor) {
    			...
    			append(div5, t12);
    			append(div5, input2);
    			set_input_value(input2, /*interestRateIn*/ ctx[2]);
    			append(div7, t13);
    			append(div7, div6);
    			append(div6, t14);
    			append(div6, t15);
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*interestRateIn*/ 4) {
    				set_input_value(input2, /*interestRateIn*/ ctx[2]);
    			}

    			if (dirty & /*interestRate*/ 16 && t14_value !== (t14_value = /*interestRate*/ ctx[4].toFixed(2) + "")) set_data(t14, t14_value);
    			if (dirty & /*monthlyPayments*/ 8 && t18_value !== (t18_value = /*formatter*/ ctx[7].format(/*monthlyPayments*/ ctx[3]) + "")) set_data(t18, t18_value);
    			if (dirty & /*totalPay*/ 64 && t21_value !== (t21_value = /*formatter*/ ctx[7].format(/*totalPay*/ ctx[6]) + "")) set_data(t21, t21_value);
    			if (dirty & /*interestPaid*/ 32 && t24_value !== (t24_value = /*formatter*/ ctx[7].format(/*interestPaid*/ ctx[5]) + "")) set_data(t24, t24_value);
    		},
    		i: noop,
    		o: noop,
    		d(detaching) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function input2_change_input_handler() {
    		interestRateIn = to_number(this.value);
    		$$invalidate(2, interestRateIn);
    	}

    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*interestRateIn*/ 4) {
    			$$invalidate(4, interestRate = interestRateIn / 100);
    		}
    		...
    		if ($$self.$$.dirty & /*loanAmount, monthlyInterestRate, totalPayments*/ 770) {
    			$$invalidate(3, monthlyPayments = loanAmount * Math.pow(1 + monthlyInterestRate, totalPayments) * monthlyInterestRate / (Math.pow(1 + monthlyInterestRate, totalPayments) - 1));
    		}

    		if ($$self.$$.dirty & /*monthlyPayments, totalPayments*/ 264) {
    			$$invalidate(6, totalPay = monthlyPayments * totalPayments);
    		}

    		if ($$self.$$.dirty & /*loanAmount*/ 2) {
    			$$invalidate(5, interestPaid = totalPaid - loanAmount);
    		}
    	};
